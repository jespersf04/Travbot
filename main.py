...
async def scan_image(files: List[UploadFile] = File(...)):
    ...
    try:
        ...
        content.append({"type": "text", "text": 'Du ser en eller flera bilder fran ATG som tillsammans visar EN startlista. Slat ihop alla hastar fran alla bilder. Returnera BARA giltig JSON utan backticks eller annan text:\n{"raceName":"Lopp X","horses":[{"number":1,"name":"NAMN","driver":"Fornamn Efternamn","odds":1.09}]}\nOm ingen startlista syns: {"error":"Inget lopp hittades"}'})
