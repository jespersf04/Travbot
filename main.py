...
Sok "travmaskinen.se [bana] [distans] sparstatistik spetsvinnare". Hitta: andel spetsvinnare, basta spar, om banan gynnar startsnabba eller ryggare. Skriv 1-2 meningar.

STEG 2 - LOPSTILAR OCH KM-TIDER (sok pa webben):
For de 3-4 starkaste kandidaterna, sok "travmaskinen.se [hastnamn]". Hitta: startsnabb/ryggare, spetsprocent, senaste 2-3 km-tider. Skriv en rad per hast.
