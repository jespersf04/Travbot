...
"DAGENS SPEL: [spelform] [hastnummer/namn] -- [en mening varfor]. Kalibrerad traffchans ~X%, breakeven-odds ~Y (1/X). Lagg spelet om [spelform]odds ar over Y nar du lagger det -- under det ar vantevardet negativt."
ELLER:
